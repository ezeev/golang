...
go install github.com/ezeev/golang/rethink-twitter/finance-pub
$GOPATH/bin/finance-pub -symbols AAPL,MSFT,GOOGL -interval 10 -nats-urls http://192.168.99.100:4222 > logs/finance.log 2>&1 &
FIN_PID=$!
...
go install github.com/ezeev/golang/rethink-twitter/twitter-sub
...
go install github.com/ezeev/golang/rethink-twitter/twitter-pub
